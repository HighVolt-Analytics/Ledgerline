...
const baseKeys = {
  ...
  accountingIntegrationsStatus: ["integrations", "accounting", "status"] as const,
  xeroPulledContacts: ["integrations", "xero", "pulled-contacts"] as const,
  qboPulledContacts: ["integrations", "qbo", "pulled-contacts"] as const,
...
export const queryKeys = {
  ...
  accountingIntegrationsStatus: () => tenantQueryKey(baseKeys.accountingIntegrationsStatus),
  xeroPulledContacts: () => tenantQueryKey(baseKeys.xeroPulledContacts),
  qboPulledContacts: () => tenantQueryKey(baseKeys.qboPulledContacts),
