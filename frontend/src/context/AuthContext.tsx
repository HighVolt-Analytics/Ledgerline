...
type AuthContextValue = {
  ...
  switchOrganisation: (tenantId: number) => Promise<void>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const applySession = useCallback(
    (access: string, refresh: string, profile: AuthUser) => {
      persistAuthSuccess({ access_token: access, refresh_token: refresh, user: profile });
      setAuthToken(access);
      setAuthUser(profile);
      setUser(profile);
    },
