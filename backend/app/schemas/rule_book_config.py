...
def _backfill_shipped_document_type_identity(data: dict[str, Any]) -> dict[str, Any]:
    """No-op: org document types must not be mutated from shipped catalogue on load/save."""
    return data


def _backfill_extraction_fields_from_shipped_defaults(data: dict[str, Any]) -> dict[str, Any]:
    """No-op: org extraction fields must not be seeded from shipped defaults on load/save."""
    return data
