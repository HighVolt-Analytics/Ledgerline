...
from app.services.extraction.azure_openai_client import embed_texts, is_azure_openai_configured
...
def _sample_text(sample: ParsedDocumentSample) -> str:
    from app.services.classification.heading_kind_recognition import infer_heading_kind
