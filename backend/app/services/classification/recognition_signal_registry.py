...
SIGNAL_PICK_GROUPS: tuple[tuple[RecognitionSignalId, ...], ...] = (
    ...
    ("text_advance_requisition", "filename_advance_requisition"),
    ("text_payment_voucher", "filename_payment_voucher"),
...
SIGNAL_CONDITIONS: dict[RecognitionSignalId, dict[str, Any]] = {
    ...
    "text_advance_requisition": {
        "field": "document_text",
        "operator": "regex",
        "value": "(?i)(?:staff\\s+|employee\\s+)?advance[\\s_-]+(?:requisition|request)",
    },
    "filename_advance_requisition": {
        "field": "attachment_name",
        "operator": "regex",
        "value": "(?i)(?:staff[_-]|employee[_-])?advance[_-]?(?:requisition|request)",
    },
    "text_payment_voucher": {
        "field": "document_text",
        "operator": "regex",
        "value": "(?i)payment[\\s_-]+voucher",
    },
    "filename_payment_voucher": {
        "field": "attachment_name",
        "operator": "regex",
        "value": "(?i)payment[_-]?voucher",
    },
    "text_claim": {
        "field": "document_text",
        "operator": "regex",
...
_SIGNAL_META: dict[RecognitionSignalId, tuple[str, str, str, str, str]] = {
    ...
    "text_advance_requisition": (
        "Body mentions advance requisition / advance request",
    ...
    "filename_advance_requisition": (
        "Filename contains advance requisition / request",
        "Attachment name",
        "filename",
        "strong",
        "advance_requisition.pdf",
    ),
    "text_payment_voucher": (
        "Body mentions payment voucher",
        "Settled payment / PV forms",
        "body",
        "strong",
        "Payment Voucher",
    ),
    "filename_payment_voucher": (
        "Filename contains payment voucher",
        "Attachment name",
        "filename",
        "strong",
        "payment_voucher.pdf",
