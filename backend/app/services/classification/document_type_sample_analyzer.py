...
from app.services.extraction.pdf_parser import parse_invoice_for_sample
from app.services.classification.playbook_profile_catalog import preset_for_profile
from app.services.classification.heading_kind_recognition import resolve_playbook_profile
from app.services.classification.recognition_signal_catalog import (
    describe_signals,
    suggest_missing_identity_signals,
    weak_signal_warning,
)
from app.services.classification.sample_cluster_service import select_primary_cluster_samples
...
def effective_proposal_signal_ids(proposal: DocumentTypeSampleProposal) -> list[str]:
    ...
    from app.services.classification.document_type_recognition_signals import identity_signals
    from app.services.classification.recognition_signal_catalog import WEAK_SIGNAL_IDS
...
def apply_sample_proposal_to_draft(
    ...
    *,
    ...
    from app.services.classification.document_classifier_builder import build_classifier_from_signals
