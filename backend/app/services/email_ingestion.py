...
def _list_unread_messages(mailbox_email: str) -> list[dict[str, object]]:
...
def _list_attachments(mailbox_email: str, message_id: str) -> list[dict[str, object]]:
    data = graph_request(
        "GET",
...
def poll_inbox(mailbox_email: str) -> list[RawEmail]:
    """
    ...
    messages = _list_unread_messages(mailbox)
    ...
    for msg in messages:
        ...
        for record in _list_attachments(mailbox, message_id):
...
def mark_message_read(message_id: str, mailbox_email: str) -> bool:
    """
