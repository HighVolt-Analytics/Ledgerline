...
_PRESET_EXTRACTION_LABELS: dict[str, str] = {
    ...
    "seller_abn": "Seller business registration number",
    "seller_address": "Seller address",
    "buyer_name": "Buyer name",
    "buyer_tax_id": "Buyer tax ID",
    "buyer_abn": "Buyer business registration number",
...
_FIELD_HINT_PATTERNS: dict[str, str] = {
    ...
    "abn": "Business registration number, GSTIN, VAT, Tax ID, ABN, Company Reg",
    ...
    "seller_tax_id": "Seller business registration number",
    "seller_address": "Seller address",
    "buyer_name": "Buyer, Bill To, Customer name",
    "buyer_tax_id": "Buyer business registration number",
