...
from app.services.customer_registry_service import resolve_customer_registry_id_for_invoice
from app.services.sales_document_service import is_commercial_sales_invoice
